/**
  ******************************************************************************
  * @file    STM32L152_Ex04_LPM_3TKeys_EVAL\src\lpm.c 
...
void StopRTCLSIMode(void)
{
  ...
  GPIO_ConfigRegisterTypeDef GPIOF_ConfigRegister;
  GPIO_ConfigRegisterTypeDef GPIOG_ConfigRegister;
  ...
  GPIO_GetConfig(GPIOF, &GPIOF_ConfigRegister);
  GPIO_GetConfig(GPIOG, &GPIOG_ConfigRegister);
...
// 	}
  ...
  GPIO_SetConfig(GPIOF, &GPIOF_ConfigRegister);
  GPIO_SetConfig(GPIOG, &GPIOG_ConfigRegister);
  GPIO_SetConfig(GPIOH, &GPIOH_ConfigRegister);
		
  /* Disable GPIOs clock not used */
  RCC_AHBPeriphClockCmd(RCC_AHBPeriph_GPIOA | RCC_AHBPeriph_GPIOC | RCC_AHBPeriph_GPIOE | RCC_AHBPeriph_GPIOH,DISABLE);
