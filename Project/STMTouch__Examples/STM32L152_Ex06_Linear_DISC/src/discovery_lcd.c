/**
  ******************************************************************************
  * @file    STM32L152_Ex06_Linear_DISC\src\discovery_lcd.c
...
void LCD_GLASS_WriteChar(uint8_t* ch, uint8_t point, uint8_t column, uint8_t position)
{
  ...
  switch (position)
  {
    ...
    case 3:
//      LCD->RAM[LCD_RAMRegister_0] &= 0xfcffffcf;
//      LCD->RAM[LCD_RAMRegister_2] &= 0xfcffffcf;
//      LCD->RAM[LCD_RAMRegister_4] &= 0xfcffffcf;
//      LCD->RAM[LCD_RAMRegister_6] &= 0xfcffffcf;
