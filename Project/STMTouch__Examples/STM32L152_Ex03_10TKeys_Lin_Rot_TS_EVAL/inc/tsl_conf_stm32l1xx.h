/**
  ******************************************************************************
  * @file    STM32L152_Ex03_10TKeys_Lin_Rot_TS_EVAL\inc\tsl_conf_stm32l1xx.h
...
*/
#define TSLPRM_TOTAL_CHANNELS (16)
...
*/
#define TSLPRM_TOTAL_TOUCHKEYS_B (10)
...
*/
#define TSLPRM_TKEY_PROX_IN_TH (12)
...
/** Linear/Rotary Proximity state input threshold (range=0..255)
  - Enter Proximity state if delta is above
*/
#define TSLPRM_LINROT_PROX_IN_TH (13)
...
/** Linear/Rotary Detect state input threshold (range=0..255)
  - Enter Detect state if delta is above
*/
#define TSLPRM_LINROT_DETECT_IN_TH (28)

/** Linear/Rotary Detect state output threshold (range=0..255)
  - Exit Detect state if delta is below
*/
#define TSLPRM_LINROT_DETECT_OUT_TH (26)
...
*/
#define TSLPRM_LINROT_CALIB_TH (28)
